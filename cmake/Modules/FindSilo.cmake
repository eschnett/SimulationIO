...
if(SILO_INCLUDE_DIR)
  foreach(_silo_version_header silo.h)
    if(EXISTS "${SILO_INCLUDE_DIR}/${_silo_version_header}")
      file(STRINGS "${SILO_INCLUDE_DIR}/${_silo_version_header}" silo_version_major_str REGEX "^#define[\t ]+_SILO_VERS_MAJ_[0-9]+")
      file(STRINGS "${SILO_INCLUDE_DIR}/${_silo_version_header}" silo_version_minor_str REGEX "^#define[\t ]+_SILO_VERS_MIN_[0-9]+")
      file(STRINGS "${SILO_INCLUDE_DIR}/${_silo_version_header}" silo_version_patch_str REGEX "^#define[\t ]+_SILO_VERS_PAT_[0-9]+")
      string(REGEX REPLACE "^#define[\t ]+_SILO_VERS_MAJ_([0-9]+).*!#define[\t ]+_SILO_VERS_MIN_([0-9]+).*!#define[\t ]+_SILO_VERS_PAT_([0-9]+).*" "\\1.\\2.\\3" SILO_VERSION_STRING "${silo_version_major_str}!${silo_version_minor_str}!${silo_version_patch_str}")
